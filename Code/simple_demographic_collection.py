...
def crawlDemographics(output_file_path, sleep_time):
    ...
    #     FacebookAdsApi.init(credentials['app_id'], credentials['secret'], credentials['token'])
    if secret != '-':
        FacebookAdsApi.init(access_token=token, app_secret=secret, api_version='v5.0')
    else:
        FacebookAdsApi.init(access_token=token, api_version='v5.0')
...
def main(argv):
    output_file_path = '/Users/range/Documents/GitHub/TCC/Code/Output'
    sleep_time = 1
